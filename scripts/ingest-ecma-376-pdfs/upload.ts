 ...
 *
 * Usage:
 *   bun scripts/ingest-ecma-376-pdfs/upload.ts <part-number> <embedded-file>
 *
 * Environment variables:
 *   DATABASE_URL - PostgreSQL connection string
 *
 * Example:
 *   bun scripts/ingest-ecma-376-pdfs/upload.ts 1 ./embedded/part1-embedded.json
 */
...
async function main() {
	...
	if (args.length < 2) {
		console.log("Usage: bun scripts/ingest-ecma-376-pdfs/upload.ts <part-number> <embedded-file>");
		console.log("");
		console.log("Environment variables:");
		console.log("  DATABASE_URL - PostgreSQL connection string");
		console.log("");
		console.log("Example:");
		console.log("  bun scripts/ingest-ecma-376-pdfs/upload.ts 1 ./embedded/part1-embedded.json");
		process.exit(1);
	}
