 ...
 *
 * Usage:
 *   bun scripts/ingest-ecma-376-pdfs/embed.ts <chunks-file> <output-file>
 *
 ...
 *
 * Example:
 *   EMBEDDING_PROVIDER=openai bun scripts/ingest-ecma-376-pdfs/embed.ts ./chunks/part1-chunks.json ./embedded/part1-embedded.json
 */
...
async function main() {
	...
	if (args.length < 2) {
		console.log("Usage: bun scripts/ingest-ecma-376-pdfs/embed.ts <chunks-file> <output-file>");
		console.log("");
		...
		console.log("Example:");
		console.log(
			"  EMBEDDING_PROVIDER=openai bun scripts/ingest-ecma-376-pdfs/embed.ts ./chunks/part1.json ./embedded/part1.json",
		);
		process.exit(1);
	}
