 ...
 *
 * Usage:
 *   bun scripts/ingest-ecma-376-pdfs/chunk.ts <extracted-dir> <output-file>
 *
 * Example:
 *   bun scripts/ingest-ecma-376-pdfs/chunk.ts ./extracted/part1 ./chunks/part1-chunks.json
 */
...
async function main() {
	...
	if (args.length < 2) {
		console.log("Usage: bun scripts/ingest-ecma-376-pdfs/chunk.ts <extracted-dir> <output-file>");
		console.log("");
		console.log("Example:");
		console.log(
			"  bun scripts/ingest-ecma-376-pdfs/chunk.ts ./extracted/part1 ./chunks/part1-chunks.json",
