...
const PATTERNS: Pattern[] = [
	...
	{ regex: /\b(?:Word|Office)\s+renders?\b/i, claimType: "layout_behavior", confidence: "medium" },
	{
		regex: /\b(?:Word|Office)\s+(?:displays?|interprets?)\b/i,
	...
	{
		regex: /\b(?:Word|Office)\s+requires\b/i,
	...
	// Generic reads.
	{
		regex: /\b(?:Word|Office)\s+reads?\b/i,
		claimType: "reads_but_does_not_write",
		confidence: "medium",
	},
];
